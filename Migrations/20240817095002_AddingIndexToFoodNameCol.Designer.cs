...
namespace SpringBootCloneApp.Migrations
{
    ...
    [Migration("20240817095002_AddingIndexToFoodNameCol")]
    partial class AddingIndexToFoodNameCol
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.Authority", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.Client", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.ClientAuthority", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint")
                        .HasColumnName("client_id");
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.ClientFoodFav", b =>
                {
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.Food", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.FoodOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.FoodOrigin", b =>
                {
                    b.Property<long>("FoodId")
                        .HasColumnType("bigint")
                        .HasColumnName("food_id");
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.FoodTag", b =>
                {
                    b.Property<long>("FoodId")
                        .HasColumnType("bigint")
                        .HasColumnName("food_id");
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.OrderItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("SpringBootCloneApp.Models.Authority", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("SpringBootCloneApp.Models.Client", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.ClientAuthority", b =>
                {
                    b.HasOne("SpringBootCloneApp.Models.Authority", "Auth")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SpringBootCloneApp.Models.Client", "Client")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.ClientFoodFav", b =>
                {
                    ...
                    b.HasOne("SpringBootCloneApp.Models.Food", "Food")
                        .WithMany("ClientFoodFavs")
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.FoodOrder", b =>
                {
                    ...
                    b.OwnsOne("SpringBootCloneApp.Models.LatLng", "LatLng", b1 =>
                        {
            ...
            modelBuilder.Entity("SpringBootCloneApp.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("SpringBootCloneApp.Models.FoodOrder", "Order")
                        .WithMany("OrderItems")
